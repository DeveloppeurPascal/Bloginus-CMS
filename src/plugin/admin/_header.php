...
<meta name="author" content="(c) Patrick Premartin / Olf Software 06/2014 - 01/2015">
...
<?php
	switch (config_getvar("jquery_cdn",""))
	{
		case "jquery":
			...
			break;
		case "google":
			$jquery_url = "//ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js";
			break;
		case "microsoft":
			$jquery_url = "//ajax.aspnetcdn.com/ajax/jQuery/jquery-1.12.0.min.js";
			break;
		default :
